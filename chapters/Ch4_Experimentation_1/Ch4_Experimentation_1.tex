...
L'intérêt a été évalué à l'aide de questionnaires adaptés de l'Inventaire de Motivation Intrinsèque (IMI) \citep{deci1994facilitating} et alignés avec les travaux de \citet{hidi2006four} sur le développement de l'intérêt situationnel et individuel (voir Annexe~\ref{annexe:imi} pour les items complets).

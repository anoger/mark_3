\chapter{Étude 1 : Impact de l'Interactivité et de la Représentation}
\label{ch:experimentation1}

\section{Mise en Œuvre et Limitations}
...
\section{Discussion}
\label{sec:exp13-discussion}

Contrairement à nos hypothèses (H1), l'interaction avec Louis, le jeune résistant, n'a pas généré plus d'intérêt que l'interaction avec de Gaulle parmi les lycéens de Terminale. L'absence de différence significative est particulièrement notable lorsqu'on la compare à l'engagement fort observé lorsque les élèves de 6\textsuperscript{ème} ont interagi avec César. Cette observation nous invite à explorer les mécanismes d'engagement spécifiques pertinents pour ce public plus âgé et plus expérimenté technologiquement.

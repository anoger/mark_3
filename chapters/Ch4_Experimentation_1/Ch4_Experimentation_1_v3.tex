...
% =============================================================================
% SECTION 4.1 : RÉSUMÉ (NOUVELLE SECTION)
% =============================================================================
...
Les mesures communes aux trois études portent sur l'intérêt des élèves, évalué à travers trois dimensions : l'intérêt pour l'activité d'apprentissage, l'intérêt pour le contenu de la leçon, et l'intérêt pour le personnage historique. Ces dimensions, adaptées de l'Inventaire de Motivation Intrinsèque \citep{deci1994} et alignées avec les travaux de \citet{hidi2006} sur le développement de l'intérêt, permettent de capturer les différentes facettes de l'intérêt suscité par l'interaction avec l'agent.

Les sections suivantes présentent d'abord les aspects transversaux de mise en œuvre technique et les considérations éthiques communes aux trois études, puis détaillent successivement chaque expérimentation avec son contexte pédagogique, ses conditions expérimentales, ses participants, sa procédure, ses hypothèses, ses résultats et leur discussion.


% =============================================================================
% SECTION 4.3 : MISE EN ŒUVRE TECHNIQUE ET LIMITATIONS
% =============================================================================
...
% =============================================================================
% SECTION 4.5 : EXPÉRIMENTATION 1.1 - L'EMPIRE FRANÇAIS (4ÈME)
% =============================================================================
...
L'étude a impliqué un échantillon de 113 élèves de 4\textsuperscript{ème} (59 filles, 54 garçons ; âge : M = 13,2 ans, ET = 0,8, étendue : 12-14 ans) recrutés dans un collège français. Les participants ont été recrutés dans quatre classes, résultant en environ 30 élèves par classe. Le recrutement a suivi le protocole éthique décrit en section~\ref{sec:exp1-ethique}.
...
L'intérêt a été évalué à l'aide de questionnaires adaptés de l'Inventaire de Motivation Intrinsèque (IMI) \citep{deci1994} et alignés avec les travaux de \citet{hidi2006} sur le développement de l'intérêt situationnel et individuel (voir Annexe~\ref{annexe:imi} pour les items complets).
...
La configuration expérimentale était identique à celle de l'Expérimentation~1.1 (voir section~\ref{subsec:exp11-dispositif}).

\subsection{Participants}
\label{subsec:exp12-participants}

La deuxième étude a impliqué un échantillon de 113 élèves de 6\textsuperscript{ème} (61 filles, 52 garçons ; âge : M = 11,2 ans, ET = 0,7, étendue : 10-12 ans) recrutés dans le même collège français. Le recrutement a suivi le protocole éthique décrit en section~\ref{sec:exp1-ethique}.

\subsection{Procédure}
\label{subsec:exp12-procedure}

Le protocole expérimental était identique à celui de l'Expérimentation~1.1 (voir section~\ref{subsec:exp11-procedure}). Le contenu pédagogique portait sur la Guerre des Gaules. Dans les conditions non interactives, la vidéo pré-enregistrée abordait des moments clés de l'histoire romaine : la carrière politique de César, son alliance avec Pompée, le Premier Triumvirat, et les événements ayant conduit à son assassinat (voir Figure~\ref{fig:classroom_caesar}).
...
La configuration expérimentale était identique à celle des études précédentes (voir section~\ref{subsec:exp11-dispositif}).

\subsection{Participants}
\label{subsec:exp13-participants}

L'Étude 3 a impliqué un échantillon de 113 lycéens de Terminale (48 filles, 65 garçons ; âge : M = 17,45 ans, ET = 0,694, étendue : 16,0-19,0 ans). Le recrutement a suivi le protocole éthique décrit en section~\ref{sec:exp1-ethique}.

\subsection{Procédure}
\label{subsec:exp13-procedure}

Le protocole expérimental était identique à celui des études précédentes (voir section~\ref{subsec:exp11-procedure}), avec deux adaptations liées au contexte lycéen. Premièrement, le contenu pédagogique portait sur la Seconde Guerre mondiale et la Résistance française. Deuxièmement, en raison de la taille plus importante des classes (environ 35 élèves), les groupes ont été ajustés pour accueillir cinq élèves chacun, portant la durée totale de l'activité à 20-25 minutes. Les lycéens ont été encouragés à poser des questions plus complexes, s'appuyant sur leurs connaissances préalables pour s'engager dans un dialogue approfondi avec les personnages virtuels.

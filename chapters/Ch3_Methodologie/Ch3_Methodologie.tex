...
Les questions de recherche formulées au chapitre précédent appellent un dispositif capable de déployer des agents conversationnels incarnés en contexte scolaire réel. Ce chapitre présente MemorIA, la plateforme expérimentale développée à cette fin. MemorIA constitue l'infrastructure technologique commune à l'ensemble des études empiriques détaillées dans les chapitres~4 et~5. Son développement a été guidé par les contraintes spécifiques de l'environnement éducatif et par les enseignements tirés de l'état de l'art sur les agents pédagogiques incarnés (cf.~\ref{sec:cadre_interaction}). Les sous-sections suivantes détaillent les objectifs et contraintes de conception, l'architecture technique, ainsi que les résultats d'une étude pilote exploratoire qui a permis de valider la faisabilité du système et d'identifier des axes d'amélioration pour les études contrôlées ultérieures.
...
\input{chapters/Ch3_Methodologie/3_2_justification_choix.tex}
\input{chapters/Ch3_Methodologie/3_2_architecture_technique.tex}

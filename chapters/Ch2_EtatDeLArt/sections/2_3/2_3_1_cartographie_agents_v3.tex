% ============================================================================
% Sous-section 2.3.1 : Cartographie des Agents Pédagogiques Virtuels (V3)
% ============================================================================
% Corrections appliquées :
% - Lacune 25 : Aération des citations denses (lignes 12-18)
% - Lacune 5 : Consolidation "effet de persona" (première mention confirmée)
% ============================================================================
...
La \textbf{première génération (1997--2011)} correspond à l'ère des pionniers. Les premiers agents pédagogiques animés émergent à la fin des années 1990. Steve (\textit{Soar Training Expert for Virtual Environments}) constitue un agent 3D guidant les marins dans l'apprentissage de procédures techniques~\citep{johnson1998steve}. Herman the Bug, agent 2D anthropomorphisé sous forme d'insecte, a démontré l'\textit{effet de persona}~: sa seule présence améliorait la motivation des apprenants, indépendamment de la qualité du feedback~\citep{lester1997lifelike}. Ce résultat fondateur, confirmé par des synthèses ultérieures~\citep{heidig2011pedagogical}, suggère que la présence d'un agent suffit à modifier l'expérience d'apprentissage.

AutoTutor a introduit le dialogue socratique automatisé, posant les bases des agents conversationnels éducatifs~\citep{graesser2004autotutor}. Ces systèmes pionniers reposaient sur des scripts prédéfinis et des arbres de décision, ce qui limitait leur flexibilité conversationnelle.

La \textbf{deuxième génération (2012--2019)} se caractérise par la consolidation empirique. Les méta-analyses se multiplient pour évaluer l'efficacité réelle des agents selon différentes variables de design~: effets de l'affect~\citep{guo2015affect}, impact des gestes, comparaisons entre apparences 2D et 3D, voix humaines et synthétiques, niveaux d'anthropomorphisme~\citep{davis2018impact}. Un constat émerge de ces synthèses~: sur 15 études avec groupe contrôle, 9 ne montrent aucune différence d'apprentissage significative, appelant à une approche plus rigoureuse~\citep{heidig2011pedagogical}. Cette génération établit les bases empiriques du domaine, mais les agents restent contraints par leurs scripts préprogrammés.

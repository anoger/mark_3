% ============================================================================
% Sous-section 2.3.2 : Fondements Cognitifs de l'Apprentissage avec Agents
% ============================================================================
% Sources : IJCCI_extraction (§2.5), Rapport Analyse, illusion_extraction
% Calibrage : ~600 mots
% Type : Révision de 2_3_1_CTML_TCC.tex (recentré, évite répétitions avec 2.1)
% ============================================================================

\subsection{Fondements Cognitifs~: Contraintes et Principes de Design}
\label{subsec:fondements_cognitifs}

L'efficacité des agents pédagogiques est contrainte par l'architecture cognitive humaine. Deux cadres théoriques informent directement leur conception~: la Théorie de la Charge Cognitive et la Théorie Cognitive de l'Apprentissage Multimédia.

...
Les gestes déictiques --- pointer vers un élément pertinent du contenu --- constituent le signal visuel le plus efficace. En dirigeant l'attention de l'apprenant vers l'information clé, ils améliorent l'apprentissage de procédures et de savoir-faire \citep{davis2018, baylor2009}. Les expressions faciales produisent des effets différents : elles favorisent l'adhésion aux messages et le changement d'attitude plutôt que l'acquisition de connaissances factuelles \citep{baylor2009}. Les gestes et expressions non directement liés au contenu améliorent néanmoins la rétention et le transfert tout en rendant l'agent plus humain, sans générer de surcharge cognitive \citep{schneider2022}. Le regard direct produit en revanche un effet inverse. Le contact visuel augmente le temps de fixation oculaire sur l'agent, ce qui devrait favoriser l'apprentissage selon les modèles attentionnels. L'effet observé est contraire : le regard direct réduit la performance, car l'apprenant consacre des ressources cognitives au traitement du regard au détriment du contenu \citep{wilson2018, wang2017}. La comparaison entre agents 2D et 3D produit un résultat contre-intuitif : les agents en 2D produisent des résultats supérieurs à ceux des agents en 3D, ce qui confirme que le réalisme géométrique ne détermine pas l'efficacité pédagogique \citep{castro-Alonso2021-qh}.

\paragraph{Bilan des méta-analyses}
Trois décennies de recherche, synthétisées dans plusieurs méta-analyses et revues systématiques, dessinent un portrait nuancé. Vingt-cinq ans de littérature montrent une évolution des systèmes tutoriels basiques vers des architectures multi-agents sophistiquées \citep{alfaro2020}. Une majorité d'études rapportent des effets positifs sur l'apprentissage \citep{marthasantoso2018}. Les élèves qui interagissent avec des agents obtiennent de meilleurs scores aux tests et montrent une participation accrue \citep{johnsonlester2016}.

Plusieurs convergences se dégagent. La voix humaine surpasse systématiquement la voix synthétique pour le transfert, et les gestes déictiques produisent l'effet visuel le plus marqué \citep{davis2018, wang2023-meta}. L'expressivité émotionnelle améliore davantage le transfert que la rétention \citep{wang2023-meta}. Les agents dotés de technologies d'IA surpassent les agents scriptés \citep{dai2024-gv}. La combinaison d'un design visuel et d'un rôle pédagogique défini produit des effets plus marqués que chaque dimension isolée \citep{marthasantoso2018}.

Ces convergences coexistent avec des résultats contradictoires. Une revue critique identifie cinq affirmations récurrentes sur les agents --- adaptabilité, réalisme, sensibilité socioculturelle, engagement, amélioration de l'apprentissage --- et constate que les preuves empiriques restent mixtes pour chacune \citep{veletsianos2013}. L'incarnation visuelle ne prédit pas l'apprentissage de façon consistante \citep{heidig2011}. Les effets motivationnels présentent un profil distinctif : les agents améliorent l'auto-efficacité et l'intérêt, mais n'ont pas d'effet détectable sur la motivation intrinsèque ni sur l'engagement \citep{gladstone2025}. Cette absence d'effet sur la motivation intrinsèque suggère que les agents activent des processus différents de ceux décrits par la SDT (cf.~\ref{subsec:sdt_cet}).

Ces divergences s'expliquent en partie par des modérateurs. L'âge joue un rôle central : les effets sont plus marqués chez les apprenants de 7-9 ans et 10-14 ans, et chez les novices, que chez les adultes et les experts \citep{johnsonlester2016, zhang2024}. Les disciplines STIM produisent des effets plus robustes que les sciences humaines \citep{alfaro2020}. La stratégie pédagogique importe plus que l'apparence : le questionnement divergent et le scaffolding métacognitif surpassent le raffinement visuel dans les études K-12 \citep{zhang2024}. Les élèves préfèrent des agents du même âge et, dans plusieurs études, des agents féminins \citep{zhang2024}. La durée de l'intervention module aussi les résultats : les sessions courtes et les sessions longues produisent des effets plus forts que les sessions intermédiaires, ce qui suggère soit un effet de nouveauté, soit la nécessité d'une exposition prolongée \citep{dai2024-gv}.

Ces bénéfices se heurtent toutefois à un plafond structurel. Les agents classiques fonctionnent à partir de scripts prédéfinis : leurs réponses sont sélectionnées dans un arbre de décision, sans adaptation au contenu de l'échange en cours. Cette rigidité érode progressivement la présence sociale, car l'apprenant détecte l'absence de contingence --- l'agent ne répond pas véritablement à ce qui a été dit, il sélectionne une réponse préformatée. La co-construction au sens du cadre ICAP (cf.~\ref{subsec:icap}) suppose que chaque contribution s'appuie sur la précédente et la transforme, ce qui exige une adaptation sémantique en temps réel que les systèmes scriptés ne peuvent pas fournir. Les revues récentes confirment ce diagnostic : malgré des effets globalement positifs, les tailles d'effet restent modestes et l'hétérogénéité des résultats suggère que les bénéfices dépendent de facteurs que le design actuel ne maîtrise pas \citep{schroeder2025}. La question qui en découle --- comment maintenir la présence sociale au-delà des premières minutes d'interaction --- appelle des architectures capables de générer des réponses contextuellement pertinentes, une capacité qui sera examinée dans la section consacrée aux IA génératives (cf.~\ref{sec:ia_generatives}).

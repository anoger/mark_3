...
Plusieurs méta-analyses et revues systématiques permettent de prendre du recul sur ces résultats individuels. Le champ a évolué des systèmes tutoriels basiques vers des architectures multi-agents sophistiquées \citep{alfaro2020}. Une majorité d'études rapportent des effets positifs sur l'apprentissage : les élèves qui interagissent avec des agents obtiennent de meilleurs scores aux tests et montrent une participation accrue \citep{marthasantoso2018, johnsonlester2016}.

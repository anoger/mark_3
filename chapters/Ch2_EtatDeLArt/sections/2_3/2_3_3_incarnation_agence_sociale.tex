...
\begin{subfigure}[t]{0.3\textwidth}
    ...
    \caption{Agent expressif \citep{ochs2010}}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.3\textwidth}
    \vspace{0pt}
...
\end{subfigure}
\caption{Évolution des agents pédagogiques sur trois décennies. De Steve (1997), premier agent pédagogique animé capable de gestes et d'expressions, aux agents expressifs modélisant des états émotionnels (2010), jusqu'aux systèmes contemporains intégrant expression multimodale (2019).}
